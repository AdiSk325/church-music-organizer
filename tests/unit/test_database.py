...
from src.database.models import Base, FileType, MusicFile, MusicPiece, Tag, UsageHistory
...
def test_create_music_piece(db_session):
    ...
    piece = MusicPiece(
        title="Ave Maria", composer="Franz Schubert", genre="Hymn", key_signature="C major"
    )
